...
public class TestPrivateObjective {
    ...
    @Test
    public void checkCalculateScore_ParamAsInstructionExample_ReturnShouldBe17() throws DieRolledValueOutOfBoundException {
        //RED
    ...
    public void checkCalculateScore_ParamAsInstructionExample_ExceptionThrown() throws DieRolledValueOutOfBoundException {
        //RED
        diceContainer.getDie(0).setRolledValue(2);
        diceContainer.getDie(1).setRolledValue(3);
        diceContainer.getDie(2).setRolledValue(3);
        ...
        this.patternCard.getPatternCardCell(1, 0).setRolledDieId(94, false, false);
        this.patternCard.getPatternCardCell(2, 0).setRolledDieId(0, false, false);
        this.patternCard.getPatternCardCell(3, 0).setRolledDieId(18, false, false);
        this.patternCard.getPatternCardCell(4, 0).setRolledDieId(72, false, false);
        ...
        privateObjective.calculateScore(patternCard);
    }
